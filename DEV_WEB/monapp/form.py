...
from .models import Personne, Produit, Lieu, Information_locale, Signalement
...
class LieuForm(forms.ModelForm):
    class Meta:
        model = Lieu
        fields = ['Nom', 'Adresse', 'Description', 'latitude', 'longitude', 'photo', 'liste_produits']


class InformationLocaleForm(forms.ModelForm):
    class Meta:
        model = Information_locale
        fields = ['nom', 'description', 'photo', 'auteur']


class SignalementForm(forms.ModelForm):
    class Meta:
        model = Signalement
        fields = ['nom', 'description', 'photo', 'auteur', 'type_signalement', 'lieu', 'produit']